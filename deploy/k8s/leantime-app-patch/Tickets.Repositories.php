...
class Tickets
{
    ...
    {
        // k8s-test patch (#60): resolve projectId BEFORE cache lookup so a
        // sessionless seed write under projectsettings..ticketlabels cannot
        // poison Kanban getStateLabels() when session('currentProject') is set.
        if ($projectId == null) {
