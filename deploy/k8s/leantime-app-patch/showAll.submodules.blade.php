                ...
                @foreach ($files as $file)
                    <li class="file-module-{{ $file['moduleId'] }}">
                        ...
                        <a class="imageLink" data-ext="{{ $file['extension'] }}" href="{{ BASE_URL }}/files/get?module={{ $file['module'] }}&encName={{ $file['encName'] }}&ext={{ $file['extension'] }}&realName={{ $file['realName'] }}">
                            ...
                            @endif
                            <span class="filename" style="display:block;max-width:9rem;overflow-wrap:anywhere;word-break:break-word;" title="{{ $file['realName'] }}.{{ $file['extension'] }}">{{ $file['realName'] }}.{{ $file['extension'] }}</span>
                        </a>
                    </li>
                @endforeach
        ...
        //window.location.reload();*/
            ...
            let html = '<li class="file-module-'+response.moduleId+'">' +
                            ...
                            '<a class="imageLink" href="{{ BASE_URL }}/files/get?module='+ response.module +'&encName='+ response.encName +'&ext='+ response.extension +'&realName='+ response.realName +'">'+
                                ...
                                '<span class="filename" style="display:block;max-width:9rem;overflow-wrap:anywhere;word-break:break-word;" title="'+response.realName+'.'+response.extension+'">'+response.realName+'.'+response.extension+'</span>'+
                            '</a>'+
                        '</li>';
