...
| **UX5** | **Space/Project 사이드바 위계**: Space 이름 중복 제거·Space settings 좌측 이동; Overview(이름·설명·수행 중 티켓) vs Tickets(Board/Backlog/Timeline/List) | Space hub·Project Overview E2E green | UX1 | done |
